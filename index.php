...
if (preg_match('#^/p/([^/]+)(/.*)?$#', $uri, $m)) {
    ...
    if ($user) {
        ...
        $shareGrant = parse_temp_share_token($cfg, (string)(<?php
...
SERVER['PORTAL_TEMP_SET'] = $shareGrant['set'];
        <?php
...
SERVER['PORTAL_TEMP_EXP'] = (string)$shareGrant['exp'];
    }
